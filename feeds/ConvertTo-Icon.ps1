# Based on: https://www.powershellgallery.com/packages/RoughDraft/0.1/Content/ConvertTo-Icon.ps1
# Params added based on: https://devblogs.microsoft.com/scripting/how-do-i-use-a-windows-powershell-script-containing-functions/
param(
# The file
...
ConvertTo-Icon -File $File -OutputFile $OutputFile
